...
import '../Css/Sistema/Familia.css';
  ...
  return (
        ...
        <nav>
            ...
            <div>
                ...
                <ul>
                    ...
                    <li className='active'><Link><i class="bi bi-people"></i> Modo Familia</Link></li>
                </ul>
            </div>
        </nav>
    ...
    <div className="sistema">
        <header className="header-rela">
            <div>
                <h2>Modo Familia</h2>
                <p className="description">Monitore os gastos em conjunto</p>
            </div>
            <button className='btn-secondary'><i class="bi bi-people"></i> Convidar Membro</button>
        </header>
    </div>
    </>
  )
