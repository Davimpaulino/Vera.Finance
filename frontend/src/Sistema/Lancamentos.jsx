...
import '../Css/Sistema/Lancamento.css';
  ...
  return (
        ...
        <nav>
            <div>
                ...
                <ul>
                    ...
                    <li className='active'><Link><i class="bi bi-credit-card"></i> Lançamentos</Link></li>
    ...
    <div className="sistema">
        <header className="header-lanc">
            <div>
                <h2>Lançamentos</h2>
                <div className="description end-header">
                    <span>48 lançamentos</span>
                    <div className="circle"></div>
                    <span>Total: R$ 3.800</span>
                </div>
            </div>
