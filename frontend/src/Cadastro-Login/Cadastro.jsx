    ...
    <>
      ...
      <div className="right">
        <div className="header">
          ...
          <p className="description">Comece a ver a verdade sobre seu dinheiro</p>
        </div>
        <form action="">
          ...
          <div className="form-group">
            ...
            <input type="password" name='senha' id='senha' minLength={6} placeholder='Minimo 6 caracteres'/>
          </div>
          <div className="form-group">
        ...
        <small>
          <span className='description'>Já possui uma conta? </span>
          <strong><Link to='/login' className='txt-primary'>Entrar</Link></strong>
        </small>
      </div>
